...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final int LEFT_FOLLOWER_ID = 2;//8;
    public static final int RIGHT_LEADER_ID = 1;//6;
    public static final int RIGHT_FOLLOWER_ID = 8;//2;
    ...
    public static final double kMaxSpeedMetersPerSecond = 1.0;// 0.7; //0.5
    public static final double kMaxAccelerationMetersPerSecondSquared = 0.5;//0.35; //0.25
